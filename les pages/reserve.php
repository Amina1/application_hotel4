			...
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post"><br><br>
						...
						<h2 class="title1">Reservation en ligne</h2>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="black">Nom:&nbsp; &nbsp;&nbsp; &nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="nom"  class="inn" size="22%" style="border:3px solid #D2691E; color:#0000FF font:Comic Sans MS"  type="text" class="Style18" id="f_1" size="21" /><br><br>
...
&nbsp;&nbsp;
 ...
 <input name="date_arrive"  class="inn" size="22%"  style="border:3px solid #D2691E; color:#0000FF font:Comic Sans MS"  id="dated" value="" size="9" wdg:mondayfirst="true" wdg:subtype="Calendar" wdg:mask="<?php echo $KT_screen_date_format; ?>" wdg:type="widget" wdg:singleclick="true" wdg:restricttomask="yes" />
                                   <br><br>
...
&nbsp;&nbsp;
 <input name="type" type="text" class="inn" size="22%" style="border:3px solid #D2691E; color:#0000FF font:Comic Sans MS"   id="type" value="<?php echo $row_rscategorie['type']; ?>"  /> 	<br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='submit' class="in" name='submit' value='Réserver' border='0'>
