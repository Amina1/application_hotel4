...
<font color="black">Découvrez toute les chambres disponible .
Un large choix pour votre réservation de chambre. 
<br>Réservez votre chambre directement en ligne .<br><br></font>
				</p>
...
if($r){
	...
	echo  "<br>"; 
	?>  
&nbsp;&nbsp;<img src="../images/<?php echo $row_rschambre['photo'];?>" style="border:5px solid #FFA500; color:#0000FF font:Comic Sans MS" height="83" width="183" alt="Chambre Single" width="50%" height="50%"  />
<img src="show.php?id=<?php echo $row['immatriculation']?>" width="50%" height="50%"  />
<?php
echo "<div class=''>";
ECHO "<div class=''>";
echo"<center >";
