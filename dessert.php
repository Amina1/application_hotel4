...
Découvrez des saveurs inexplorées, que vous soyez résidents de l’hôtel ou simplement de passage à Essaouira.</div>
 ...
 <li><img src="images/picto-fcoldsnack.gif" width="39" height="34" alt=""><a href="boisson.php"><font color="#fff">Boisson</a></li>
                     	<li><img src="images/picto-fhotmeal.gif" width="39" height="34" alt=""><a href="#"><font color="#fff">Desserts:</a></li>
                        <li><font color="black" class="pla" >*Gâteau au chocolat sans oeufs</li>
                        <li><font color="black" class="pla" >*Gâteau au yaourt</li>
                        <li><font color="black" class="pla" >*Galette des rois frangipane</li>
                        <li><font color="black" class="pla" >*Flan pâtissier</li>
                        <li><font color="black" class="pla" >*Fruits caramélisés au miel et aux pistaches</li>
                        <li><font color="black" class="pla" >*Tarte aux pommes</li>
                        <li><font color="black" class="pla" >* Soupe de fraises et framboises aux feuilles de menthe<br><br></li>   
                     </ul>
