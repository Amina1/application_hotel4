...
Découvrez des saveurs inexplorées, que vous soyez résidents de l’hôtel ou simplement de passage à Essaouira.</div>
  ...
  <div id="im"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="970px" height="252px">
      <param name="movie" value="siham4.swf?xml_path=slides.xml" />
      <param name="quality" value="high" />
      <embed  style="margin-left: 13px; margin-top: 13px;" src="siham4.swf?xml_path=slides.xml" width="444px" height="230px" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>
    </object></div></div></div>
 ...
 <ul>
                     	...
                     	<li><img src="images/picto-fhotmeal.gif" width="39" height="34" alt=""><a href="#"><font color="#fff">Plats chauds:</a></li>
                        <li><font color="black" class="pla" >*Tajine de poulet aux olives et champignons (cuisse de poulet ou poulet entier)</li>
                        <li ><font color="black" class="pla" >*Tajine de boulettes de viande hachée assaisonnée(kefta)</li>
                        <li><font color="black" class="pla" >*Pilon de poulet avec accompagnement légumes</li>
                        <li><font color="black" class="pla" >*Couscous avec sa viande d'agneau et son bouillon de légumes</li>
                        <li><font color="black" class="pla" >*Paupiette de dinde farci avec accompagnement légume</li>
                        <li><font color="black" class="pla" >*Pastilla ( fruit de mer ou poulet)</li>
						 <li><img src="images/picto-fcoldsnack.gif" width="39" height="34" alt=""><a href="boisson.php"><font color="#fff">Boisson</a></li>
                        <li><img src="images/picto-fcoldsnack.gif" width="39" height="34" alt=""><a href="dessert.php"><font color="#fff">Dessert<br><br></a></li>
                     </ul>
...
<p >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="index.php">Accueil</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="les pages/chambres.php">Chambres & Tarifs</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="les pages/reservation.php">Réservation</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="les pages/contact.php">Contact</a>
